...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/(site)" | "/(admin)" | "/" | "/(site)/about" | "/(site)/account" | "/(site)/account/change-password" | "/(site)/account/orders" | "/(admin)/admin" | "/(admin)/admin/orders" | "/(admin)/admin/orders/[id]" | "/(admin)/admin/orders/[id]/manage" | "/(admin)/admin/products" | "/(admin)/admin/products/[id]" | "/(admin)/admin/roles" | "/(admin)/admin/users" | "/(admin)/admin/users/[id]" | "/(site)/auth" | "/(site)/auth/forgot" | "/(site)/auth/login" | "/(site)/auth/register" | "/(site)/cart" | "/(site)/checkout" | "/(site)/contact" | "/(site)/products" | "/(site)/products/[id]";
		RouteParams(): {
		...
		Pathname(): "/" | "/about" | "/about/" | "/account" | "/account/" | "/account/change-password" | "/account/change-password/" | "/account/orders" | "/account/orders/" | "/admin" | "/admin/" | "/admin/orders" | "/admin/orders/" | `/admin/orders/${string}` & {} | `/admin/orders/${string}/` & {} | `/admin/orders/${string}/manage` & {} | `/admin/orders/${string}/manage/` & {} | "/admin/products" | "/admin/products/" | `/admin/products/${string}` & {} | `/admin/products/${string}/` & {} | "/admin/roles" | "/admin/roles/" | "/admin/users" | "/admin/users/" | `/admin/users/${string}` & {} | `/admin/users/${string}/` & {} | "/auth" | "/auth/" | "/auth/forgot" | "/auth/forgot/" | "/auth/login" | "/auth/login/" | "/auth/register" | "/auth/register/" | "/cart" | "/cart/" | "/checkout" | "/checkout/" | "/contact" | "/contact/" | "/products" | "/products/" | `/products/${string}` & {} | `/products/${string}/` & {};
